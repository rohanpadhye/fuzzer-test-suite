...
if [[ ! -d seeds ]]; then
  mkdir seeds
  cp BUILD/fuzz/client_corpus/* seeds/
fi
...
set -x
$CXX $CXXFLAGS -I BUILD/include BUILD/fuzz/client.cc ./BUILD/ssl/libssl.a ./BUILD/crypto/libcrypto.a $LIB_FUZZING_ENGINE -lpthread -o $EXECUTABLE_NAME_BASE
